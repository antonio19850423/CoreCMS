...
namespace Velora.Host.Controllers
{
    ...
    public class ProductAttributeValueController : ControllerBase, IDynamicFormController<ProductAttributeValueCrud>
    {
        private readonly IProductAttributeValueService _ProductAttributeValueService;
        private readonly ITransactionService _transactionService;

        public ProductAttributeValueController(IProductAttributeValueService ProductAttributeValueService, ITransactionService transactionService)
        {
        ...
        {
            var result = await _ProductAttributeValueService.GetAllAsync();
            return Ok(result);
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] ProductAttributeValueCrud ProductAttributeValue)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<ProductAttributeValueDto>
                {
                    Success = false,
            ...
            var result = await _ProductAttributeValueService.CreateAsync(ProductAttributeValue);
            if (!result.Success)
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<IActionResult> Update([FromBody] ProductAttributeValueCrud dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<ProductAttributeValueDto>
                {
            ...
            var result = await _ProductAttributeValueService.UpdateAsync(dto);
            if (!result.Success)
                return NotFound(result);
        ...
        public async Task<IActionResult> BulkInsert()
        {
            ...
            var result = await _ProductAttributeValueService.BulkInsertAsync(stream);
        ...
        public async Task<IActionResult> Export([FromBody] ExportRequestDto request)
        {
            ...
            try
            {
                fileBytes = await _ProductAttributeValueService.ExportAsync(
