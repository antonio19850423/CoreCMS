...
namespace Velora.Host.Controllers
{
    ...
    public class ProductSalesManagementController : ControllerBase, IDynamicFormController<ProductSalesManagementCrud>
    {
        private readonly IProductSalesManagementService _ProductSalesManagementService;
        private readonly ITransactionService _transactionService;

        public ProductSalesManagementController(IProductSalesManagementService ProductSalesManagementService, ITransactionService transactionService)
        {
        ...
        {
            var result = await _ProductSalesManagementService.GetAllAsync();
            return Ok(result);
        }
        ...
        {
            var result = await _ProductSalesManagementService.GetByIdAsync(id);
            if (!result.Success)
        ...
        public async Task<IActionResult> Export([FromBody] ExportRequestDto request)
        {
            ...
            try
            {
                fileBytes = await _ProductSalesManagementService.ExportAsync(
        ...
        [HttpPost]
        public Task<IActionResult> Create([FromBody] ProductSalesManagementCrud dto)
        {
            throw new NotImplementedException();
        }
        [HttpPut]
        public Task<IActionResult> Update([FromBody] ProductSalesManagementCrud dto)
        {
            throw new NotImplementedException();
        }
        [HttpDelete("{id}")]
