...
namespace Velora.Host.Controllers
{
    ...
    public class ProductCategoryController : ControllerBase, IDynamicFormController<ProductCategoryCrud>
    {
        private readonly IProductCategoryService _ProductCategoryService;
        private readonly ITransactionService _transactionService;

        public ProductCategoryController(IProductCategoryService ProductCategoryService, ITransactionService transactionService)
        {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] ProductCategoryCrud ProductCategory)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<ProductCategoryDto>
                {
                    Success = false,
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<IActionResult> Update([FromBody] ProductCategoryCrud dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<ProductCategoryDto>
                {
        ...
        public async Task<IActionResult> BulkInsert()
        {
            ...
            var result = await _ProductCategoryService.BulkInsertAsync(stream);
        ...
        public async Task<IActionResult> Export([FromBody] ExportRequestDto request)
        {
            ...
            try
            {
                fileBytes = await _ProductCategoryService.ExportAsync(
