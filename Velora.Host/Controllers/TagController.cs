...
namespace Velora.Host.Controllers
{
    ...
    public class TagController : ControllerBase, IDynamicFormController<TagCrud>
    {
        private readonly ITagService _TagService;
        private readonly ITransactionService _transactionService;

        public TagController(ITagService TagService, ITransactionService transactionService)
        {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] TagCrud Tag)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<TagDto>
                {
                    Success = false,
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<IActionResult> Update([FromBody] TagCrud dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<TagDto>
                {
        ...
        public async Task<IActionResult> BulkInsert()
        {
            ...
            var result = await _TagService.BulkInsertAsync(stream);
        ...
        public async Task<IActionResult> Export([FromBody] ExportRequestDto request)
        {
            ...
            try
            {
                fileBytes = await _TagService.ExportAsync(
