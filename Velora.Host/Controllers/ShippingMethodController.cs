...
namespace Velora.Host.Controllers
{
    ...
    public class ShippingMethodController : ControllerBase, IDynamicFormController<ShippingMethodCrud>
    {
        private readonly IShippingMethodService _ShippingMethodService;
        private readonly ITransactionService _transactionService;

        public ShippingMethodController(IShippingMethodService ShippingMethodService, ITransactionService transactionService)
        {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] ShippingMethodCrud ShippingMethod)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<ShippingMethodDto>
                {
                    Success = false,
            ...
            var result = await _ShippingMethodService.CreateAsync(ShippingMethod);
            if (!result.Success)
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<IActionResult> Update([FromBody] ShippingMethodCrud dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<ShippingMethodDto>
                {
            ...
            var result = await _ShippingMethodService.UpdateAsync(dto);
            if (!result.Success)
                return NotFound(result);
        ...
        public async Task<IActionResult> BulkInsert()
        {
            ...
            var result = await _ShippingMethodService.BulkInsertAsync(stream);
        ...
        public async Task<IActionResult> Export([FromBody] ExportRequestDto request)
        {
            ...
            try
            {
                fileBytes = await _ShippingMethodService.ExportAsync(
