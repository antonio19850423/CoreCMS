...
namespace Velora.Host.Controllers
{
    ...
    public class ProductInventoryTransactionController : ControllerBase, IDynamicFormController<ProductInventoryTransactionCrud>
    {
        private readonly IProductInventoryTransactionService _ProductInventoryTransactionService;
        private readonly ITransactionService _transactionService;

        public ProductInventoryTransactionController(IProductInventoryTransactionService ProductInventoryTransactionService, ITransactionService transactionService)
        {
        ...
        {
            var result = await _ProductInventoryTransactionService.GetAllAsync();
            return Ok(result);
        }
        ...
        {
            var result = await _ProductInventoryTransactionService.GetByIdAsync(id);
            if (!result.Success)
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] ProductInventoryTransactionCrud ProductInventoryTransaction)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<ProductInventoryTransactionDto>
                {
                    Success = false,
            ...
            var result = await _ProductInventoryTransactionService.CreateAsync(ProductInventoryTransaction);
            if (!result.Success)
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<IActionResult> Update([FromBody] ProductInventoryTransactionCrud dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<ProductInventoryTransactionDto>
                {
            ...
            var result = await _ProductInventoryTransactionService.UpdateAsync(dto);
            if (!result.Success)
                return NotFound(result);
        ...
        {
            var result = await _ProductInventoryTransactionService.DeleteAsync(id);
            if (!result.Success)
                return NotFound(result);
        ...
        public async Task<IActionResult> BulkInsert()
        {
            ...
            var result = await _ProductInventoryTransactionService.BulkInsertAsync(stream);
        ...
        public async Task<IActionResult> Export([FromBody] ExportRequestDto request)
        {
            ...
            try
            {
                fileBytes = await _ProductInventoryTransactionService.ExportAsync(
