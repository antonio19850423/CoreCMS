...
namespace Velora.Host.Controllers
{
    ...
    public class DiscountController : ControllerBase, IDynamicFormController<DiscountCrud>
    {
        private readonly IDiscountService _DiscountService;
        private readonly ITransactionService _transactionService;

        public DiscountController(IDiscountService DiscountService, ITransactionService transactionService)
        {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] DiscountCrud Discount)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<DiscountDto>
                {
                    Success = false,
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<IActionResult> Update([FromBody] DiscountCrud dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<DiscountDto>
                {
        ...
        public async Task<IActionResult> BulkInsert()
        {
            ...
            var result = await _DiscountService.BulkInsertAsync(stream);
        ...
        public async Task<IActionResult> Export([FromBody] ExportRequestDto request)
        {
            ...
            try
            {
                fileBytes = await _DiscountService.ExportAsync(
