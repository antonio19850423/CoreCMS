...
namespace Velora.Host.Controllers
{
    ...
    public class ProductTypeController : ControllerBase, IDynamicFormController<ProductTypeCrud>
    {
        private readonly IProductTypeService _ProductTypeService;
        private readonly ITransactionService _transactionService;

        public ProductTypeController(IProductTypeService ProductTypeService, ITransactionService transactionService)
        {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] ProductTypeCrud ProductType)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<ProductTypeDto>
                {
                    Success = false,
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<IActionResult> Update([FromBody] ProductTypeCrud dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<ProductTypeDto>
                {
            ...
            var result = await _ProductTypeService.UpdateAsync(dto);
            if (!result.Success)
                return NotFound(result);
        ...
        public async Task<IActionResult> BulkInsert()
        {
            ...
            var result = await _ProductTypeService.BulkInsertAsync(stream);
        ...
        public async Task<IActionResult> Export([FromBody] ExportRequestDto request)
        {
            ...
            try
            {
                fileBytes = await _ProductTypeService.ExportAsync(
