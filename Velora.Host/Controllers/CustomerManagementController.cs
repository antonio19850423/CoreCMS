...
namespace Velora.Host.Controllers
{
    ...
    public class CustomerManagementController : ControllerBase, IDynamicFormController<CustomerManagementCrud>
    {
        private readonly ICustomerManagementService _CustomerManagementService;
        private readonly ITransactionService _transactionService;

        public CustomerManagementController(ICustomerManagementService CustomerManagementService, ITransactionService transactionService)
        {
        ...
        {
            var result = await _CustomerManagementService.GetAllAsync();
            return Ok(result);
        }
        ...
        {
            var result = await _CustomerManagementService.GetByIdAsync(id);
            if (!result.Success)
        ...
        public async Task<IActionResult> Export([FromBody] ExportRequestDto request)
        {
            ...
            try
            {
                fileBytes = await _CustomerManagementService.ExportAsync(
        ...
        [HttpPost]
        public Task<IActionResult> Create([FromBody] CustomerManagementCrud dto)
        {
            throw new NotImplementedException();
        }
        [HttpPut]
        public Task<IActionResult> Update([FromBody] CustomerManagementCrud dto)
        {
            throw new NotImplementedException();
        }
        [HttpDelete("{id}")]
