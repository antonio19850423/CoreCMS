...
namespace Velora.Host.Controllers
{
    ...
    public class InventoryTransactionReasonController : ControllerBase, IDynamicFormController<InventoryTransactionReasonCrud>
    {
        private readonly IInventoryTransactionReasonService _InventoryTransactionReasonService;
        private readonly ITransactionService _transactionService;

        public InventoryTransactionReasonController(IInventoryTransactionReasonService InventoryTransactionReasonService, ITransactionService transactionService)
        {
        ...
        {
            var result = await _InventoryTransactionReasonService.GetAllAsync();
            return Ok(result);
        }
        ...
        {
            var result = await _InventoryTransactionReasonService.GetByIdAsync(id);
            if (!result.Success)
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] InventoryTransactionReasonCrud InventoryTransactionReason)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<InventoryTransactionReasonDto>
                {
                    Success = false,
            ...
            var result = await _InventoryTransactionReasonService.CreateAsync(InventoryTransactionReason);
            if (!result.Success)
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<IActionResult> Update([FromBody] InventoryTransactionReasonCrud dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<InventoryTransactionReasonDto>
                {
            ...
            var result = await _InventoryTransactionReasonService.UpdateAsync(dto);
            if (!result.Success)
                return NotFound(result);
        ...
        {
            var result = await _InventoryTransactionReasonService.DeleteAsync(id);
            if (!result.Success)
                return NotFound(result);
        ...
        public async Task<IActionResult> BulkInsert()
        {
            ...
            var result = await _InventoryTransactionReasonService.BulkInsertAsync(stream);
        ...
        public async Task<IActionResult> Export([FromBody] ExportRequestDto request)
        {
            ...
            try
            {
                fileBytes = await _InventoryTransactionReasonService.ExportAsync(
