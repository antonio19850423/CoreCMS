...
namespace Velora.Host.Controllers
{
    ...
    public class ProductAttributeController : ControllerBase, IDynamicFormController<ProductAttributeCrud>
    {
        private readonly IProductAttributeService _ProductAttributeService;
        private readonly ITransactionService _transactionService;

        public ProductAttributeController(IProductAttributeService ProductAttributeService, ITransactionService transactionService)
        {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] ProductAttributeCrud ProductAttribute)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<ProductAttributeDto>
                {
                    Success = false,
            ...
            var result = await _ProductAttributeService.CreateAsync(ProductAttribute);
            if (!result.Success)
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<IActionResult> Update([FromBody] ProductAttributeCrud dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<ProductAttributeDto>
                {
            ...
            var result = await _ProductAttributeService.UpdateAsync(dto);
            if (!result.Success)
                return NotFound(result);
        ...
        public async Task<IActionResult> BulkInsert()
        {
            ...
            var result = await _ProductAttributeService.BulkInsertAsync(stream);
        ...
        public async Task<IActionResult> Export([FromBody] ExportRequestDto request)
        {
            ...
            try
            {
                fileBytes = await _ProductAttributeService.ExportAsync(
