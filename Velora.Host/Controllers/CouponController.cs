...
namespace Velora.Host.Controllers
{
    ...
    public class CouponController : ControllerBase, IDynamicFormController<CouponCrud>
    {
        private readonly ICouponService _CouponService;
        private readonly ITransactionService _transactionService;

        public CouponController(ICouponService CouponService, ITransactionService transactionService)
        {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] CouponCrud Coupon)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<CouponDto>
                {
                    Success = false,
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<IActionResult> Update([FromBody] CouponCrud dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<CouponDto>
                {
        ...
        public async Task<IActionResult> BulkInsert()
        {
            ...
            var result = await _CouponService.BulkInsertAsync(stream);
        ...
        public async Task<IActionResult> Export([FromBody] ExportRequestDto request)
        {
            ...
            try
            {
                fileBytes = await _CouponService.ExportAsync(
