...
namespace Velora.Host.Controllers
{
    ...
    public class PaymentController : ControllerBase, IDynamicFormController<PaymentCrud>
    {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] PaymentCrud Payment)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<PaymentDto>
                {
                    Success = false,
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<IActionResult> Update([FromBody] PaymentCrud dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<PaymentDto>
                {
        ...
        public async Task<IActionResult> BulkInsert()
        {
            ...
            var result = await _PaymentService.BulkInsertAsync(stream);
        ...
        public async Task<IActionResult> Export([FromBody] ExportRequestDto request)
        {
            ...
            try
            {
                fileBytes = await _PaymentService.ExportAsync(
