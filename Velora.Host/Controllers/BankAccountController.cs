...
namespace Velora.Host.Controllers
{
    ...
    public class BankAccountController : ControllerBase, IDynamicFormController<BankAccountCrud>
    {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] BankAccountCrud BankAccount)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<BankAccountDto>
                {
                    Success = false,
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<IActionResult> Update([FromBody] BankAccountCrud dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<BankAccountDto>
                {
        ...
        public async Task<IActionResult> BulkInsert()
        {
            ...
            var result = await _BankAccountService.BulkInsertAsync(stream);
        ...
        public async Task<IActionResult> Export([FromBody] ExportRequestDto request)
        {
            ...
            try
            {
                fileBytes = await _BankAccountService.ExportAsync(
