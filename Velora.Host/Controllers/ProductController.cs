...
namespace Velora.Host.Controllers
{
    ...
    public class ProductController : ControllerBase, IDynamicFormController<ProductCrud>
    {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] ProductCrud Product)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<ProductDto>
                {
                    Success = false,
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<IActionResult> Update([FromBody] ProductCrud dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ResultDto<ProductDto>
                {
        ...
        public async Task<IActionResult> BulkInsert()
        {
            ...
            var result = await _ProductService.BulkInsertAsync(stream);
        ...
        public async Task<IActionResult> Export([FromBody] ExportRequestDto request)
        {
            ...
            try
            {
                fileBytes = await _ProductService.ExportAsync(
