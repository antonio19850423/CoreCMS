...
public class ProductAttributeGqlResolver : IProductAttributeGqlResolver
{
    IProductAttributeService _ProductAttributeService;
    public ProductAttributeGqlResolver(IProductAttributeService ProductAttributeService)
    {
    ...
    /// <returns></returns>
    [Authorize]
    [GraphQLName("productAttributeView")]
    [UsePaging(IncludeTotalCount = true)]
    [UseFiltering]
    [UseSorting]
    public async Task<IQueryable<ProductAttributeCrud>> productAttributeView()
    {
        var query = await _ProductAttributeService
            .GetAllViewQueryable<SqlProductAttributeView, SqlProductAttributeView, ProductAttributeCrud>();
        return query.Select(x => new ProductAttributeCrud
        {
            Id = x.Id,
