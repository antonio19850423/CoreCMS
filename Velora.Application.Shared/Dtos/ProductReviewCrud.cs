...
{
    public class ProductReviewCrud : BulkInsert
    {
        ...
        [ResourceColumn(FieldType = FieldTypes.Text, FormOrder = 6, GridOrder = 6, ShowInGrid = true, ShowInForm = true, MaxLength = 400)]
        ...
        [ResourceColumn(FieldType = FieldTypes.Lable, FormOrder = 8, GridOrder = 8, ShowInGrid = false, ShowInForm = true)]
