...
{
    public class ProductAttributeCrud : BulkInsert {
        ...
        [ResourceColumn(FieldType = FieldTypes.Text, FormOrder = 2, GridOrder = 2, ShowInGrid = true, ShowInForm = true, MaxLength = 100, ShowInSelectBox = true, IsRequired = true)]
        public string Code { get; set; } = null!;


        [ResourceColumn(FieldType = FieldTypes.Textarea, FormOrder = 3, GridOrder = 3, ShowInGrid = true, ShowInForm = true, MaxLength = 500, ShowInSelectBox = true)]
        public string? Description { get; set; }

        [ResourceColumn(FieldType = FieldTypes.Number, FormOrder = 4, GridOrder = 4, ShowInGrid = false, ShowInForm = true)]
