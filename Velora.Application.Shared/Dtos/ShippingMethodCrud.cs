...
{
    public class ShippingMethodCrud : BulkInsert
    {
        ...
        [ResourceColumn(FieldType = FieldTypes.Textarea, FormOrder = 2, GridOrder = 2, ShowInGrid = true, ShowInForm = true, MaxLength = 1000, IsRequired = true)]
        ...
        [ResourceColumn(FieldType = FieldTypes.Number, FormOrder = 4, GridOrder =4, ShowInGrid = true, ShowInForm = true, IsRequired = true)]
