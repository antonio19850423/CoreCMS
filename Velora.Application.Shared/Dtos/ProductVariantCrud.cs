...
namespace Velora.Application.Shared.Dtos
{
    public class ProductVariantCrud : BulkInsert
    {
        ...
        [ResourceColumn(FieldType = FieldTypes.Number, FormOrder = 2, GridOrder = 2, ShowInGrid = true, ShowInForm = true, IsRequired = true)]
        public decimal Price { get; set; }
        [ResourceColumn(FieldType = FieldTypes.Number, FormOrder = 3, GridOrder = 3, ShowInGrid = true, ShowInForm = true, IsRequired = true)]
        public decimal? ComparePrice { get; set; }
        [ResourceColumn(FieldType = FieldTypes.Image, FormOrder = 4, GridOrder = 4, ShowInGrid = true, ShowInForm = true, MaxLength = 300)]
        public string? Image { get; set; }

        [ResourceColumn(FieldType = FieldTypes.Text, FormOrder = 5, GridOrder = 5, ShowInGrid = true, ShowInForm = true, MaxLength = 100, IsRequired = true)]
